...
public class Manuel_Vue extends JFrame implements WindowListener{
	...
	public Manuel_Vue() throws IOException{
		...
		explication1.add(new JLabel ("Vous pouvez récoltez vos ressources en cliquant"));
		explication1.add(new JLabel (" sur les objets colorés."));
		explication1.add(new JLabel ("Les objets grisés sont disponible quand vous avez débloqué"));
		...
		explication3.add(new JLabel ("          - l'objet dont la matrice que vous avez créé n'existe pas"));
		explication3.add(new JLabel ("          - vous n'avaez pas assez de matériaux. Dans ce cas, les"));
		explication3.add(new JLabel ("matériaux que vous n'avez pas en assez grande quantité sont affichés."));
		gbc3.gridx=1;
		gbc3.gridy=1;
		gbc3.ipadx=40;
		...
		explication4.add(new JLabel ("afin d'en connaître le nom."));
		...
		explication4_2.add(new JLabel ("pour connaître la matrice permettant de"));
